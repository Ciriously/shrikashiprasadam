    ...
    return (
        <div className="flex items-center font-inter justify-center h-screen">
            <div className="w-full  max-w-md px-14 py-10 bg-white shadow-md rounded-xl">
                ...
                <button
                    onClick={handleLogin}
                    className="w-full bg-[#F26414] text-white font-semibold py-2 mt-4 rounded-md hover:bg-indigo-600 focus:outline-none focus:bg-indigo-600"
                >
                    SIGN IN
                </button>
                ...
                <div className="text-right mt-2">
                    <a href="/forgot-password" className="text-[#575757] text-sm">Forgot Password?</a>
                </div>
                ...
                <button
                    onClick={''}
                    className="w-full bg-[#F26414] text-white font-semibold py-2 rounded-md hover:bg-indigo-600 focus:outline-none focus:bg-indigo-600 mt-4"
                >
                    CREATE AN ACCOUNT
                </button>
            </div>
